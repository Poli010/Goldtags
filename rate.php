        ...
        <div class="product-image">
            ...
            <div class="product-info">
                <form id="form" action="add_to_cart.php" method="post">
                    ...
                    <label for="product_amount">Product Price: <i class="fa-solid fa-peso-sign"></i><span name="product_price"><?php echo $row['product_price'] ?></span></label><br>
                    <input type="hidden" name="product_amount" value="<?php echo $row['product_price'] ?>">
